...
if __name__ == "__main__":
    ...
    repository = os.path.abspath(os.path.join(test_directory, ".."))

    for dir in path:
        if dir.lower() == repository:
            path.remove(dir)

    # Change to a temporary working directory to prevent aliasing
    with TemporaryDirectory() as temp_dir:
        ...
        if os.path.isfile(start_dir):
            ...
            tests = test_loader.discover(os.path.join(test_directory, 'tests', start_dir), top_level_dir=test_directory)
