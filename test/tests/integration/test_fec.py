...
try:
    from hermespy.fec import EncoderManager, LDPCCoding, TurboCoding, RepetitionEncoder, Scrambler3GPP, BlockInterleaver, CyclicRedundancyCheck, PolarSCCoding, RSCCoding, BCHCoding
except ImportError:
    raise SkipTest("AFF3CT bindings are not installed")
