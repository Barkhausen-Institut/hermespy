...
class TestRFSignal(TestCase):
    ...
    def test_rf_power(self) -> None:
        """Test the RF power property of RF signals"""

        new_reference_impedance = 75.0
        self.signal.reference_impedance = new_reference_impedance
        expected_power = self.signal.power / new_reference_impedance
        assert_array_almost_equal(expected_power, self.signal.rf_power, 1e-3)
