...
from hermespy.hardware_loop import DeviceTransmissionPlot, DeviceReceptionPlot, EvaluatorPlotMode, EvaluatorRegistration, EyePlot, ReceivedConstellationPlot, HardwareLoop, HardwareLoopPlot, HardwareLoopSample, PhysicalScenarioDummy, PhysicalDeviceDummy
...
class TestEvaluatorRegistration(TestCase):
    ...
    def test_confidence_setget(self) -> None:
        ...
        self.registration.confidence = 0.
        self.assertEqual(0., self.registration.confidence)
        
    def test_tolerance_setget(self) -> None:
        """Tolerance property getter should return setter argument"""
        
        self.registration.tolerance = 0.
        self.assertEqual(0., self.registration.tolerance)
...
class TestHardwareLoop(TestCase):
    ...
    def test_run(self) -> None:
        ...
        self.hardware_loop.new_dimension('carrier_frequency', [0., 1e6, 1e9], device)
