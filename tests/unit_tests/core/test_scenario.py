...
class MockScenario(Scenario):
    ...
    def _drop(self) -> Drop:
        ...
        return Drop(0., transmissions, receptions)
...
class TestScenario(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.transmitter_alpha = SilentTransmitter(10, 1.)
        self.transmitter_beta = SilentTransmitter(10, 1.)
        self.receiver_alpha = SignalReceiver(10, 1.)
        self.receiver_beta = SignalReceiver(10, 1.)
    ...
    def test_campaign_validation(self) -> None:
        ...
        with patch('hermespy.core.scenario.Scenario.mode', new_callable=PropertyMock) as mode_mock, \
             patch('hermespy.core.scenario.Scenario._Scenario__campaign_exists') as campaign_exists_mock:
    ...
    def test_process_inputs(self) -> None:
        ...
        impinging_signals = [Signal(self.rng.random((1, 10)), 1., 0.) for _ in range(self.scenario.num_devices)]
