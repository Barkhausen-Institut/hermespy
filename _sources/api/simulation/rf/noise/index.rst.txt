...
the :class:`NoiseModel<hermespy.simulation.rf.noise.model.NoiseModel>` representing the noise's statistical properties and
the :class:`NoiseLevel<hermespy.simulation.rf.noise.level.NoiseLevel>` representing the noise's power level.

When generating a new realization of the statistical :class:`NoiseModel<hermespy.simulation.rf.noise.model.NoiseModel>`,
the expected power returned by the :class:`NoiseLevel's<hermespy.simulation.rf.noise.level.NoiseLevel>`
:meth:`get_power()<hermespy.simulation.rf.noise.level.NoiseLevel.get_power>` method is passed to the
:meth:`realize<hermespy.simulation.rf.noise.model.NoiseModel.realize>` method
to obtain a :class:`NoiseRealization<hermespy.simulation.rf.noise.model.NoiseRealization>` instance.
...
.. list-table::
   ...
   * - :class:`AWGN<hermespy.simulation.rf.noise.model.AWGN>`
     - :class:`AWGNRealization<hermespy.simulation.rf.noise.model.AWGNRealization>`
...
.. list-table::
   ...
   * - :class:`N0<hermespy.simulation.rf.noise.level.N0>`
     - Noise power spectral density.
   * - :class:`ThermalNoise<hermespy.simulation.rf.noise.level.ThermalNoise>`
     - Thermal noise level depending on the system bandwidth and temperature.
   * - :class:`SNR<hermespy.simulation.rf.noise.level.SNR>`
     - Signal-to-noise ratio with respect to a reference.
   * - :class:`EBN0<hermespy.simulation.modem.noise.EBN0>`
     - Bit energy to noise power ratio with respect to a waveform.
   * - :class:`ESN0<hermespy.simulation.modem.noise.ESN0>`
