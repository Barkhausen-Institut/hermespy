...
.. inheritance-diagram:: hermespy.modem.waveform_single_carrier.RaisedCosineWaveform
   :parts: 1
   :top-classes: hermespy.modem.waveform.CommunicationWaveform

The raised cosine waveform is a single-carrier modulation scheme filtering the communication
symbols with a raised cosine pulse shape:
...
.. literalinclude:: ../../scripts/examples/modem_waveforms_rc.py
   :language: python
   :linenos:
   :lines: 17-25
...
.. autoclass:: hermespy.modem.waveform_single_carrier.RaisedCosineWaveform
