...
class Scrambler3GPP(Encoder):
    ...
    def __init__(self, params: ParametersScrambler,
                       bits_in_frame: int,
                       rng: np.random.RandomState=None) -> None:

        # Init base class (Encoder)
        super(Scrambler3GPP, self).__init__(params, bits_in_frame, rng)
...
class Scrambler80211a(Encoder):
    ...
    def __init__(self, params: ParametersScrambler,
        ...
        # Init base class (Encoder)
        super(Scrambler80211a, self).__init__(params, bits_in_frame, rng)
