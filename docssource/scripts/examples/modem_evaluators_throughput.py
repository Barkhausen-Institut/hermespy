...
from hermespy.modem import ThroughputEvaluator, TransmittingModem, ReceivingModem, RootRaisedCosineWaveform
...
simulation.add_evaluator(ThroughputEvaluator(modem_alpha, modem_beta))
