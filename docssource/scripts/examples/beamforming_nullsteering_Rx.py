...
# Configure the base station device to receive the probing signal
...
# Create three simulated devices representing the user equipments
...
user_equipment_transmitter_3 = TransmittingModem(waveform=deepcopy(waveform))
user_equipment_device_1.add_dsp(user_equipment_transmitter_1)
user_equipment_device_2.add_dsp(user_equipment_transmitter_2)
user_equipment_device_3.add_dsp(user_equipment_transmitter_3)
...
# Run the simulation and analyze the constellation diagram of the received signal from the UEs.
...
simulation.add_evaluator(ConstellationEVM(user_equipment_transmitter_3, base_station_receiver))
