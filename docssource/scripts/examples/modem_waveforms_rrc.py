...
tx_device = simulation.new_device(carrier_frequency=1e10, bandwidth=1e6, oversampling_factor=4)
rx_device = simulation.new_device(carrier_frequency=1e10, bandwidth=1e6, oversampling_factor=4)
