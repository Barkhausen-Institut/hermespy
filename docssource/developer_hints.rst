...
This will execute all unit tests located under `test/tests/unit`.
Additional tests for the integration of modules and the integrity of configuration files and examples
can be found under `test/tests/integration` and `test/tests/integrity`, respectively.
