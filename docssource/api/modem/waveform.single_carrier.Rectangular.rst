...
.. inheritance-diagram:: hermespy.modem.waveform_single_carrier.RectangularWaveform
   :parts: 1
   :top-classes: hermespy.modem.waveform.CommunicationWaveform

The recangular waveform is a single-carrier modulation scheme filtering the communication
...
.. literalinclude:: ../../scripts/examples/modem_waveforms_rect.py
   :language: python
   :linenos:
   :lines: 17-24
...
.. autoclass:: hermespy.modem.waveform_single_carrier.RectangularWaveform
