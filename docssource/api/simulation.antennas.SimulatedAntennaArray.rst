...
decsription by :class:`RfChain<hermspy.simulation.rf_chain.rf_chain.RfChain>` models
...
.. list-table::
   ...
   * - :doc:`Custom<simulation.antennas.SimulatedCustomArray>`
     - Custom antenna array with aribtray antenna types, positions and orientations

   * - :doc:`Uniform<simulation.antennas.SimulatedUniformArray>`
...
.. toctree::
   ...
   simulation.antennas.SimulatedCustomArray
   simulation.antennas.SimulatedUniformArray
