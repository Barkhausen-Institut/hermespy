...
For each frame, the :class:`ReceiveStreamCoding<hermespy.precoding.stream_precoding.ReceiveStreamCoding>`
configured by the :attr:`receive_stream_coding<hermespy.modem.modem.ReceivingModem.receive_stream_coding>`
...
The :class:`StatedSymbols<hermespy.modem.symbols.StatedSymbols>` will then be :meth:`decoded<hermespy.precoding.symbol_precoding.SymbolPrecoding.decode>`
