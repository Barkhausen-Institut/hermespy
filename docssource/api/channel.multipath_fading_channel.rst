...
For MIMO configurations with :doc:`Devices<simulation.simulated_device.SimulatedDevice>` featuring multiple transmit- or receive-antennas,
...
The base equations are implemented in the :doc:`channel.multipath_fading_channel.MultipathFadingChannel` and its respective
:doc:`channel.multipath_fading_channel.MultipathFadingRealization`.
Users may directly use the :doc:`channel.multipath_fading_channel.MultipathFadingChannel` with their own parameter sets.
More conveniently, several standard parameterizations such as :doc:`channel.multipath_fading_templates.MultipathFading5GTDL`,
:doc:`channel.multipath_fading_templates.MultipathFadingCost259` and :doc:`channel.multipath_fading_templates.MultipathFadingExponential`
are provided.
...
.. toctree::
   ...
   channel.multipath_fading_channel.MultipathFadingChannel
   channel.multipath_fading_channel.MultipathFadingRealization
   channel.multipath_fading_channel.PathRealization
   channel.multipath_fading_channel.AntennaCorrelation
   channel.multipath_fading_channel.CustomAntennaCorrelation
