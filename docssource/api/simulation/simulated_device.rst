...
are available in HermesPy's :doc:`/api/modem/index`, :doc:`/api/radar/index` and :doc:`/api/jcas/index` modules.
...
.. mermaid::
   ...
   click output "simulated_device.SimulatedDeviceOutput.html" "SimulatedDeviceOutput"
   click deviceTransmission "simulated_device.SimulatedDeviceTransmission.html" "SimulatedDeviceTransmission"
   click triggerRealization "synchronization.TriggerRealization.html" "TriggerRealization"
...
.. mermaid::
   ...
   click device_realization "simulated_device.SimulatedDeviceReceiveRealization.html" "SimulatedDeviceReceiveRealization"
   click processed_input "simulated_device.ProcessedSimulatedDeviceInput.html" "ProcessedSimulatedDeviceInput"
   ...
   click device_reception "simulated_device.SimulatedDeviceReception.html" "SimulatedDeviceReception"
...
.. toctree::
   ...
   simulated_device.SimulatedDeviceOutput
   simulated_device.SimulatedDeviceReceiveRealization
   simulated_device.SimulatedDeviceReception
   simulated_device.SimulatedDeviceTransmission
   simulated_device.ProcessedSimulatedDeviceInput

.. autoclass:: hermespy.simulation.simulated_device.SimulatedDevice

.. autoclass:: hermespy.simulation.simulated_device.SimulatedDeviceState
