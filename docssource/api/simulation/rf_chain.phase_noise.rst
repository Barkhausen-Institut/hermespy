...
.. list-table::
   ...
   * - :doc:`rf_chain.phase_noise.NoPhaseNoise`
     - No phase noise is added to the signal.

   * - :doc:`rf_chain.phase_noise.OscillatorPhaseNoise`
...
.. toctree::
   ...
   rf_chain.phase_noise.NoPhaseNoise
   rf_chain.phase_noise.OscillatorPhaseNoise
