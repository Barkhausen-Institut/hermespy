# -*- coding: utf-8 -*-
#
# In this example we simulate a frame of modulated overlapping chirps.
#
...
# Sweep over the receive Eb/N0 from -20 dB to 10 dB and the modulation order from 4 to 64
rx_device.noise_level = EBN0(link)
simulation.new_dimension("noise_level", dB(range(-20, 11)), rx_device)
