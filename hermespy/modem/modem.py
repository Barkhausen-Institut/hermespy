...
class TransmittingModemBase(Generic[CWT], BaseModem[CWT]):
    ...
    def __init__(self, bits_source: BitsSource | None = None, *args, **kwargs) -> None:
        ...
        _selected_transmit_ports = kwargs.pop("selected_transmit_ports", None)
...
class DuplexModem(TransmittingModem, ReceivingModem):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # Initialize base classes
        _selected_receive_ports = kwargs.pop("selected_receive_ports", None)
        ReceivingModem.__init__(self, selected_receive_ports=_selected_receive_ports)
