...
class Artifact(ABC):
    ...
    In other words, :meth:`Evaluator.evaluate<hermespy.core.pymonte.evaluation.Evaluator.evaluate>` is expected to return an instance derived of this base class.
