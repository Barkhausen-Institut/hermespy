...
class ActorRunResult(object):
    ...
    @property
    def samples(self) -> dict[tuple[int, ...], ray.ObjectRef[list[MonteCarloSample]]]:
...
class MonteCarloActor(Generic[MO]):
    ...
    def run(self, program: List[Tuple[int, ...]]) -> ActorRunResult:
        ...
        try:
            ...
            samples_dict: dict[tuple[int, ...], list[MonteCarloSample]] = {}

            # Run through the program steps
            for section_indices in program:
                if section_indices not in samples_dict:
                    samples_dict[section_indices] = []
                samples_list = samples_dict[section_indices]
            ...
            result = ActorRunResult(
                samples={
                    section: ray.put(samples) for section, samples in samples_dict.items()
                },
                message=None,
            )
