...
class EvaluationResult(ABC):
    ...
    @staticmethod
    def _plot_linear(grid: List[GridDimension], sample_points: Sequence[np.float_], scalar_data: np.ndarray, evaluator: Evaluator, figure: plt.Figure) -> None:
    ...
    @staticmethod
    def _plot_surface(grid: List[GridDimension], sample_points: Sequence[np.float_], data: np.ndarray, evaluator: Evaluator, figure: plt.Figure) -> None:
...
class ScalarEvaluationResult(ProcessedScalarEvaluationResult):
    ...
    def __init__(self, grid: Sequence[GridDimension], section_artifacts: np.ndarray, evaluator: Evaluator, plot_surface: bool = True) -> None:
