...
class Visualization(ABC):
    ...
    def __init__(self, figure: Figure | None, axes: VAT) -> None:
        """
        Args:
...
class PlotVisualization(Visualization):
    ...
    def __init__(self, figure: Figure, axes: VAT, lines: VLT) -> None:
        """
        Args:
...
class StemVisualization(Visualization):
    ...
    def __init__(self, figure: Figure | None, axes: VAT, container: StemContainer) -> None:
        """
        Args:
...
class ScatterVisualization(Visualization):
    ...
    def __init__(self, figure: Figure | None, axes: VAT, paths: VLT) -> None:
        """
        Args:
...
class ImageVisualization(Visualization):
    ...
    def __init__(self, figure: Figure, axes: VAT, image: AxesImage) -> None:
        """
        Args:
...
class QuadMeshVisualization(Visualization):
    ...
    def __init__(self, figure: Figure, axes: VAT, mesh: QuadMesh) -> None:
        """
        Args:
...
class Visualizable(Generic[VT], ABC):
    ...
    @abstractmethod
    def _prepare_visualization(self, figure: Figure | None, axes: VAT, **kwargs) -> VT:
    ...
    def visualize(
        self, axes: VAT | Axes | None = None, *, title: str | None = None, **kwargs
    ) -> VT:
        ...
        with Executable.style_context():
            if axes is not None:
                _axes: VAT = axes if isinstance(axes, np.ndarray) else np.array([[axes]])  # type: ignore[assignment]
