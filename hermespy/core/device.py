...
class DeviceTransmission(DeviceOutput):
    ...
    @classmethod
    def From_Output(cls: Type[DeviceTransmission],
                    output: DeviceOutput,
                    operator_transmissions: List[Transmission]) -> DeviceTransmission:
...
class ProcessedDeviceInput(DeviceInput):
    ...
    def __init__(self,
                 ...
                 operator_inputs: List[Tuple[Signal, ChannelStateInformation]]) -> None:
        """
        Args:
...
class Device(ABC, RandomNode):
    ...
    def generate_output(self,
                        operator_transmissions: Optional[List[Transmission]] = None) -> DeviceOutput:
    ...
    def process_input(self,
                      ...
                      cache: bool = True) -> ProcessedDeviceInput:
    ...
    def receive_operators(self,
                          operator_inputs: Optional[List[Union[Signal, Tuple[Signal, ChannelStateInformation]]]] = None,
                          cache: bool = True) -> List[Reception]:
        """Receive over the registered operators.
        
        Args:

            operator_inputs (List[Union[Signal, Tuple[Signal, ChannelStateInformation]]], optional):
        ...
        for operator, input in zip(self.receivers, operator_inputs):
