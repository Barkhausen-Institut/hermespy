...
class TransmitterSlot(OperatorSlot[Transmitter]):
    ...
    __transmissions: List[Optional[Transmission]]       # Next signals to be transmitted
    ...
    def get_transmissions(self,
        ...
        """for operator_idx, signal in enumerate(self.__transmissions):
