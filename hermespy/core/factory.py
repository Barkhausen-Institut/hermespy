...
class Serializable(object):
    ...
    def serialize(self, process: SerializationProcess) -> None:
        ...
        Objects cannot be serialized directly, instead a :class:`Factory` must be instructed to carry out the serialization process.

        Args:
            process (SerializationProcess):
                The current stage of the serialization process.
                This object is generated by the :class:`Factory` and provides an interface to serialization methods supporting multiple backends.
        """
        ...  # pragma: no cover
    ...
    def Deserialize(
        ...
        Objects cannot be deserialized directly, instead a :class:`Factory` must be instructed to carry out the deserialization process.

        Args:

            process (DeserializationProcess):
                The current stage of the deserialization process.
                This object is generated by the :class:`Factory` and provides an interface to deserialization methods supporting multiple backends.
...
class Factory:
    ...
    def to_HDF(self, target: str | Group, serializable: Serializable) -> None:
        ...
        Args:
            target (str): Path to the configuration file or HDF5 file-like object.
...
class SerializationProcess(ProcessBase):
    ...
    def serialize_array(self, array: np.ndarray, name: str, cache: bool = True) -> None:
        ...
        Args:
            array (numpy.ndarray): The numpy array to be serialized.
            name (str): Name of the dataset.
            cache (bool, optional): Cache the array for future reference. Defaults to :py:obj:`True`.
        """
        ...  # pragma: no cover
    ...
    def serialize_object(self, obj: Serializable, name: str, root: bool = False) -> None:
        ...
        Args:
            ...
            name (str): Name of the dataset.
            root (bool, optional): Serialize the object as a root object. Defaults to :py:obj:`False`.
    ...
    def _serialize_object(self, obj: Serializable, name: str, type: str, root: bool) -> None:
        ...
        Args:
            obj (Serializable): The object to be serialized.
            name (str): Name of the dataset.
            type (str): The object's serialization tag.
        """
        ...  # pragma: no cover
    ...
    def serialize_object_sequence(
        ...
        Args:
            ...
            name (str): Name of the dataset.
            append (bool, optional): Append the objects to the dataset if it already exists. Defaults to :py:obj:`False`.
        """
        ...  # pragma: no cover
    ...
    def serialize_object_mapping(
        ...
        Args:
            ...
            name (str): Name of the dataset.
            append (bool, optional): Append the objects to the dataset if it already exists. Defaults to :py:obj:`True`.
        """
    ...
    def serialize_custom(
        ...
        Args:
            name (str): Name of the dataset.
            serializer (Callable[[SerializationProcess], None]): Serialization function to be executed.
        """
        ...  # pragma: no cover
...
class DeserializationProcess(ProcessBase):
    ...
    def deserialize_array(
        ...
        Args:
            name (str): Name of the dataset.
            dtype (DTypeLike): Expected data type of the array.
            default (numpy.ndarray, optional): Default value to be returned if the value does not exist.
    ...
    def deserialize_floating(self, name: str, default: float | UNDEF_TYPE = UNDEF) -> float:
        ...
        Args:
            name (str): Name of the dataset.
            default (float, optional): Default value to be returned if the value does not exist.
    ...
    def deserialize_complex(self, name: str, default: complex | UNDEF_TYPE = UNDEF) -> complex:
        ...
        Args:
            name (str): Name of the dataset.
            default (complex, optional): Default value to be returned if the value does not exist.
    ...
    def deserialize_integer(self, name: str, default: int | UNDEF_TYPE = UNDEF) -> int:
        ...
        Args:
            name (str): Name of the dataset.
            default (int, optional): Default value to be returned if the value does not exist.
    ...
    def deserialize_string(self, name: str, default: str | UNDEF_TYPE = UNDEF) -> str:
        ...
        Args:
            name (str): Name of the dataset.
            default (str, optional): Default value to be returned if the value does not exist.
    ...
    def _deserialize_object(self, name: str, expected_type: Type[_OT], default: _RT) -> _OT | _RT:
        ...
        Args:
            name (str): Name of the dataset.
            expected_type (Type[_OT]): Expected type of the deserialized object.
            default (_RT): Default value to be returned if the object does not exist.
    ...
    def deserialize_object(self, name: str, type: Type[_OT] | Sequence[Type[_OT]], /) -> _OT:
        ...
        Args:
            ...
            name (str): Name of the dataset.
            type (Type[_OT]): Expected type of the deserialized object.
    ...
    def deserialize_object(
        ...
        Args:
            ...
            name (str): Name of the dataset.
            type (Type[_OT]): Expected type of the deserialized object.
            default (Any): Default value to be returned if the dataset does not exist.
    ...
    def deserialize_object(self, name: str, /, *args) -> Any:
        ...
        Args:
            ...
            name (str): Name of the dataset.
            \*args (Any): Optional arguments for method overloading.
    ...
    def deserialize_object_sequence(
        ...
        Args:
            name (str): Name of the dataset.
            type (Type[_OT]): Expected type of the deserialized objects.
            start (int, optional): Index of the first object in the sequence. Defaults to zero.
            stop (int, optional): Index of the last object in the sequence. Defaults to :py:obj:`None`, i.e. the end of the sequence.
    ...
    def deserialize_range(
        ...
        Args:
            ...
            name (str): Name of the dataset.
            default (Any, optional): Default value to be returned if the dataset does not exist.
    ...
    def deserialize_custom(
        ...
        Args:
            name (str): Name of the dataset.
            callback (Callable[[DeserializationProcess], _OT]): Callback function to be executed.
