...
class ReceiveBeamformer(ReceiveStreamDecoder, ABC):
    ...
    def plot_receive_pattern(self,
        ...
        if signal is None:
            ...
            samples = self.operator.device.antennas.spherical_response(self.operator.device.carrier_frequency, 0., 0.)
            signal = Signal(samples[:, np.newaxis], 1., self.operator.device.carrier_frequency)
    ...
    def PlotReceivePattern(cls,
        ...
        device.antennas = UniformArray(IdealAntenna(), .5 * device.wavelength, (8, 8))
