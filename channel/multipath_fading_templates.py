...
class MultipathFading5GTDL(MultipathFadingChannel):
    ...
    def __init__(self,
        ...
        if model_type == self.TYPE.A:
            ...
            delays = np.asarray([0, 0.3819, 0.4025, 0.5868, 0.4610, 0.5375, 0.6708, 0.5750, 0.7618,
            ...
            delays = np.asarray([0, 0.1072, 0.2155, 0.2095, 0.2870, 0.2986, 0.3752, 0.5055, 0.3681, 0.3697,
            ...
            delays = np.asarray([0, 0.2099, 0.2219, 0.2329, 0.2176, 0.6366, 0.6448, 0.6560, 0.6584, 0.7935,
